...
```{r 3 species histo, echo = FALSE, eval = FALSE}
...
The box-plot above shows, for each species, the percentage variation among individuals in the percentage of tracking days on which birds were detected at least once at any station in the array.

```{r 3 species plot value table, echo = TRUE, eval = TRUE}
