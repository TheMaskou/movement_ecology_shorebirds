...
```{r recever names, message = FALSE, warning = FALSE, eval = TRUE, echo = FALSE}
...
# Extract only the station_rename object
station_rename <- temp_env$station_rename
rm(temp_env)
...
```{r 1 final filtering, message = FALSE, warning = FALSE, eval = TRUE, echo = TRUE}
...
```{r 1 Band ID BIS, message = FALSE, warning = FALSE, eval = TRUE, echo = FALSE}
...
```{r 1 Band ID, message = FALSE, warning = FALSE, eval = TRUE, echo = TRUE}
...
```{r 1 Tide data, message = FALSE, warning = FALSE, eval = TRUE, echo = TRUE}
...
```{r 1 variable, message = FALSE, warning = FALSE, eval = TRUE, echo = TRUE}
...
```{r 1 species NA, message = FALSE, warning = FALSE, eval = TRUE, echo = FALSE}
...
```{r 1 save .rds, message = FALSE, warning = FALSE, eval = TRUE, echo = TRUE}
...
To reproduce any of the analysis of this Research Project, simply [**click and download the data**](https://uoneduau-my.sharepoint.com/:u:/g/personal/c3541851_uon_edu_au/IQAxU8zWYFxmTbW90BrF1w03AelgXNvwPTNmD4gd7LORT8o?e=rHrZzq) *(a password might be required - maxime.marini\@uon.edu.au)*.
