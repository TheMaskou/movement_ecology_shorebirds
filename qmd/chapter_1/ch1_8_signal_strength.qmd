...
library(here)
source(here::here("qmd", "chapter_1", "R", "ch1_8_signal_strength.R"))
```
...
```{r compute variables, echo = TRUE, eval = FALSE}
...
```{r plot list, echo = TRUE, eval = FALSE, results = 'asis'}
