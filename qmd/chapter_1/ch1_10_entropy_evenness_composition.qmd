...
```{r shannon, message = FALSE, warning = FALSE, eval = FALSE, echo = TRUE}
...
```{r shannon 2, message = FALSE, warning = FALSE, eval = FALSE,  echo = TRUE}
...
```{r shannon 4, message = FALSE, warning = FALSE, eval = FALSE,  echo = TRUE, results = 'hide'}
...
```{r shannon 5, message = FALSE, warning = FALSE, eval = FALSE, echo = TRUE, results = 'hide', include = FALSE}
...
```{r shannon tide 1, message = FALSE, warning = FALSE, eval = FALSE,  echo = TRUE, results = 'hide'}
...
```{r shannon tide 4, message = FALSE, warning = FALSE, eval = FALSE,  echo = FALSE}
...
```{r shannon tide 5, message = FALSE, warning = FALSE, eval = FALSE,  echo = TRUE}
...
```{r jensen-shannon, message = FALSE, warning = FALSE, eval = FALSE, echo = TRUE}
...
```{r jensen-shannon 2, message = FALSE, warning = FALSE, eval = FALSE, echo = TRUE}
...
```{r jensen-shannon 4, message = FALSE, warning = FALSE, eval = FALSE, echo = TRUE}
...
```{r jensen-shannon tide 9, message = FALSE, warning = FALSE, eval = FALSE, echo = FALSE}
...
```{r jensen-shannon tide 11, message = FALSE, warning = FALSE, eval = FALSE,  echo = FALSE}
# Pivot data to prepare plotting
...
```{r jensen-shannon tide 13, message = FALSE, warning = FALSE, eval = FALSE,  echo = TRUE}
...
```{r jensen-shannon tide 15, message = FALSE, warning = FALSE, eval = FALSE,  echo = FALSE}
...
::: panel-tabset
```{r assumptions tabs, message = FALSE, warning = FALSE, results = 'asis', echo = FALSE, eval = TRUE ,fig.width = 10, fig.height = 6}
