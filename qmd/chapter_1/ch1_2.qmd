...
**Find below a our data summarised across species and up to date** (last detection `r max(data_all$dateAus)`)**.**
...
And have a hint about the **conditions of detection for each species**, in the figure below *- see further details in [Station usage rate > Detection conditions](qmd/chapter_1/ch1_7.qmd)*.

```{r explore, message = FALSE, results = 'asis', include = FALSE, warning = FALSE, echo = FALSE, eval = TRUE}
