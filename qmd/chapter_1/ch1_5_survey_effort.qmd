...
library(here)
source(here::here("qmd", "chapter_1", "R", "ch1_5_survey_effort.R"))
```
...
```{r  clarifying stations,  message = FALSE, warning = FALSE, eval = FALSE}
...
```{r 2 Extracting listening periods,  message = FALSE, warning = FALSE, eval = FALSE}
...
```{r table MOTUS array survey effort,  message = FALSE, warning = FALSE, eval = FALSE}
...
```{r 2 hour MOTUS array survey effort,  message = FALSE, warning = FALSE, eval = FALSE, echo = FALSE}
...
Find in [Chapter 1 \> Station usage - hours \> Condition detections](https://themaskou.github.io/movement_ecology_shorebirds/qmd/chapter_1/ch1_7_station_usage_hours.html#detection-conditions) the number of hours a species have been detected and where, depending the four categories of tide (Low, High, Day, Night).
