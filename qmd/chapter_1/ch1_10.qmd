...
<img src="../../material/exempleshannon.png" style="width: 100%; height: auto; display: block;"/>
...
Before to display and visualise result, we build a t-test which will compare entropy values between low tide and high tide for each species.  
