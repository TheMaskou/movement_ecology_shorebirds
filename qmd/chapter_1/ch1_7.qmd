...
We removed **n = `r nrow(above)`** out of `r nrow(all)` cases where the *time used* was over the *available*.
...
::: blockquote-yellow
We filtered out Masked Lapwing and Far Eastern Curlew from the analysis, since they have too few data.
:::
