...
**Legend**: Summary for each species and per Motus station of the number of hours a species has been detected and the number of hours the station has been listening while the species had at least one individual with an activated tag on (survey effort).   
